...
let numero1 = Math.floor (Math.random () * starWarsCharacters.length);

console.log(starWarsCharacters[numero1].name);
console.log(starWarsCharacters[numero1].height);
console.log(starWarsCharacters[numero1].mass);
console.log(starWarsCharacters[numero1].hair_color);
console.log(starWarsCharacters[numero1].skin_color);
console.log(starWarsCharacters[numero1].eye_color);
console.log(starWarsCharacters[numero1].birth_year);
console.log(starWarsCharacters[numero1].gender);
